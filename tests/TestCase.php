...
abstract class TestCase extends BaseTestCase
{
    ...
    const INVALID_TEST_TABLE_RECORD = [
        'name' => '',
        'description' => [1 => 2],
        'is_active' => ['aa'],
    ...
    const UPDATED_VALID_TEST_TABLE_RECORD = [
        'table_id' => 4, // this is the primary key, it should be present in the record to update
